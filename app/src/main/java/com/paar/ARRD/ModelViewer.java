...
public class ModelViewer extends AndARActivity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSurfaceView().setOnTouchListener(new TouchEventHandler()); // maybe take these two lines out
		getSurfaceView().getHolder().addCallback(this); // and send to a activity that has the menu selections and its own surfaceView()
	}
