...
public class Model implements Serializable{
	...
	protected HashMap<String, Material> materials = new HashMap<String, Material>(); // dont need <String, Material> -- can just have <>
	...
	public void setScale(float f) {
		this.scale += f;
		if(this.scale < 0.001f) // 0.0001f
			this.scale = 0.001f; // 0.0001f
	}
